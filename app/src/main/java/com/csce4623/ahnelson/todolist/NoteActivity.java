...
public class NoteActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    {
        //String [] position = new String[] {Integer.toString(getIntent().getExtras().getInt("POSITION"))};
    ...
    {
        //String position = Integer.toString(getIntent().getExtras().getInt("POSITION"));
        int position = getIntent().getExtras().getInt("POSITIONS");
        //Create the projection for the query
        String[] projection = {
                ToDoProvider.TODO_TABLE_COL_ID,
                ToDoProvider.TODO_TABLE_COL_TITLE,
